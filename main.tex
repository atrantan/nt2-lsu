...
programming tools, \fxwarning*{Why is it difficult?}{but it is still difficult
to fully utilize new architectures}. In this context, new paradigms are
...
model for the whole cluster. \fxwarning*{Citation needed}{But using these models, parallel programs tend to
