...
\documentclass[conference]{acmsig-alternate-10pt}
\usepackage{array}
\usepackage{multirow}
...
\author{
\alignauthor
\small \textbf{Antoine Tran Tan} \\ %\titlenote{}\\
       \affaddr{\small LRI, Universit\'e Paris-Sud XI}\\
       \affaddr{\small Orsay, France}\\
       \email{\small \texttt{antoine.trantan@lri.fr}}
\alignauthor
\small \textbf{Joel Falcou}\\
       \affaddr{\small LRI, Universit\'e Paris-Sud XI}\\
       \affaddr{\small Orsay, France}\\
       \email{\small \texttt{joel.falcou@lri.fr}}
\alignauthor
\small \textbf{Daniel Etiemble}\\
       \affaddr{\small LRI, Universit\'e Paris-Sud XI}\\
       \affaddr{\small Orsay, France}\\
       \email{\small \texttt{de@lri.fr}}
\and
\alignauthor
\small \textbf{Bryce Adelstein-Lelbach}\\
       \affaddr{\small CCT, Louisiana State University}\\
       \affaddr{\small Baton Rouge, USA}\\
       \email{\small \texttt{blelbach@cct.lsu.edu}}
\alignauthor
\small \textbf{Harmut Kaiser}\\
       \affaddr{\small CCT, Louisiana State University}\\
       \affaddr{\small Baton Rouge, USA}\\
       \email{\small \texttt{hkaiser@cct.lsu.edu}}
}
