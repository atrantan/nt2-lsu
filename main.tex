...
\begin{figure}[h]
	...
	{
		\includegraphics[scale=0.35]{Images/Im2.png}
	}
	\hspace{0.5cm}
	\subfloat[Program with Futures]
	{
		\includegraphics[scale=0.35]{Images/Im3.png}
	}	
	\caption{Timing diagrams of example code}
	\label{chronofuture}
\end{figure}
...
\begin{figure}[h!]
	\centering
	\subfloat[\centering add20\newline$2395\times2395$]
	{
		\includegraphics[scale=0.24]{Images/add20m.png}
	}
	\hspace{1cm}
	\subfloat[\centering orsreg1\newline$2205\times2205$]
	{
		\includegraphics[scale=0.24]{Images/orsreg1m.png}
	}
	\hspace{1cm}
	\subfloat[pde900\newline$900\times900$]
	{
		\includegraphics[scale=0.24]{Images/pde900m.png}
	}\\
	\subfloat[\centering orsirr1\newline$1030\times1030$]
	{
		\includegraphics[scale=0.24]{Images/orsirr1m.png}
	}
	\hspace{1cm}
	\subfloat[\centering sherman1\newline$1000\times1000$]
	{
		\includegraphics[scale=0.24]{Images/sherman1m.png}
	}
